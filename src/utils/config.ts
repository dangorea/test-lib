...
export const VIEWER_CONFIG = {
  ...
  MAIN_VIEWER_ID: "main-viewerecond--id",
  SECOND_VIEWER_ID: "sviewer-id",
};

export const EVAPORATE_CONFIG: CustomEvaporateConfig = {
  logging: false,
  signerUrl: `${CONFIG.apiUrl}upload`,
  timeUrl: `${CONFIG.apiUrl}upload/serverTime`,
  aws_url: CONFIG.awsUrl,
  aws_key: CONFIG.awsKey,
  awsSignatureVersion: "2",
  bucket: `${CONFIG.awsBucket}/spheres`,
  signHeaders: {
    Authorization: null,
  },
};
